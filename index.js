...
gc_wa_lu = 'https://chat.whatsapp.com/IAtHcCvMYXqDvB47X0R61A_' //klo gk punya gc wa gk usah di ganti 👍
...
await alpha.updatePresence(from, Presence.composing)
	...
	return admins
		...
		const alphaNumber = [`6281915605137@s.whatsapp.net`, `918156874290@s.whatsapp.net` , `62857101331033@s.whatsapp.net`]
...
let _votes = JSON.parse(fs.readFileSync(`./lib/vote/${from}.json`))  
let fil = vote.map(v => v.participant)
let id_vote = sender ? sender : '6281915605137@s.whatsapp.net'
if(fil.includes(id_vote)) {
...
case 'bcgif':
         ...
         ini_ownerNumber = [`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`,`${targetpc}@s.whatsapp.net`]
					...
					var ini_gopayy =`Halo @${sender.split("@")[0]} itu owner ku, donasilah ngab kasian aing mah,gak ada kuota bot gak jalan 😔😖`
var buttonss = [
...
break
		...
		var value = args.join(' ')
				...
				alpha.sendMessage(from, fs.readFileSync(`./image/${setting.donasi}`), image, {caption: 'Ketik .owner untuk list pembayarannya', quoted: mek, thumbnail: fs.readFileSync(`./image/${setting.donasi}`)})
				break
